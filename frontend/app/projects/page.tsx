...
import PoiVisualizerCard from '@/app/ui/projects/poi-visualizer-card';
        ...
        <main className="max-w-4xl mx-auto px-6 py-20">
            ...
            <div className="space-y-10">
                <RagCard
                    ...
                    finished={true}
                    relevant_topics={["LANGGRAPH", "GEMINI API", "PYTHON"]}
                />

                <Divider className="opacity-10" />

                <PoiVisualizerCard
                    projectName="OSM POI Visualizer"
                    projectId="poi_visualizer"
                    projectDescription={poiVisualizerDescription}
                    finished={false}
                    relevant_topics={["OSM"]}
                />
